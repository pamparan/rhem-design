 ...
 *
 * Features:
 * - Application title (Red Hat Edge Manager)
 * - List of buttons for each enabled authentication provider
 * - Clean, centered layout for user experience
 */
              ...
              <Stack hasGutter>
                {enabledProviders.map((provider) => (
                  <StackItem key={provider.id}>
                    <Button
                      variant={provider.id === 'internal' ? 'primary' : 'secondary'}
                      isBlock
                      size="lg"
...
export default StandaloneLoginWireframe;